...
module Interop =
    [<System.Runtime.InteropServices.DllImport(@"dxva2.dll", EntryPoint="GetMonitorBrightness", SetLastError=true)>]
    ...
    [<System.Runtime.InteropServices.DllImport(@"user32.dll", EntryPoint="MonitorFromWindow", SetLastError=true)>]
    ...
    [<System.Runtime.InteropServices.DllImport("user32.dll", EntryPoint="RegisterHotKey", SetLastError=true)>]
    extern int RegisterHotKey([<In>] nativeint hWnd, int id, int fsModifiers, int vk);

    [<System.Runtime.InteropServices.DllImport("user32.dll", EntryPoint="UnregisterHotKey", SetLastError=true)>]
